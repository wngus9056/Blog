...
<p class="content">
  [4] Relationship<br>
  <img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FH8d2u%2FbtqD9uaZF7p%2FvUJuoF6G4piVLbEzTlEEd1%2Fimg.png" width="350" height="400"><br>
  - 관계는 Actor와 Usecase, Usecase와 Usecase 사이에 나타나고 총 4가지 종류가 있다.<br>
  <br>
  association<br>
  - Usecase와 Actor의 관계를 표현할 때 쓰인다.<br>
  - Actor는 정보를 요구하거나 받고, Usecase는 정보를 제공한다.<br>
  ...
  - 일반적으로 여러 기능에서 공통으로 사용해야 하는 모듈같은 기능에 추가되는 키워드이다.<br>
